...
let AppService = class AppService {
    ...
    async handleTenantDbReady(payload) {
        console.log(`RECEIVED EVENT: Mock creating DNS record for ${payload.subdomain}`);
        try {
            await sleep(2000);
            console.log(`SUCCESS: Mock created DNS record for ${payload.subdomain}`);
            await this.amqpConnection.publish('provisioning.direct', 'tenant.dns.ready', {
...
], AppService.prototype, "handleTenantDbReady", null);
